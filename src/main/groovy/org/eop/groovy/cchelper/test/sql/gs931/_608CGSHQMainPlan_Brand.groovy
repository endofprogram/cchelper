...
class _608CGSHQMainPlan_Brand extends AbstractSqlTest {

    @Override
    Map getSqlFile() {
        [dir:'E:\\Work\\java\\cchelper_gen\\', name:'608品牌查询']
    }
    ...
    @Override
    Map getInInterface() {
        [route:'', name:'甘肃能开_接入_品牌查询', clsnm:'userMobileCommonIntfService', type:'1', path:'business/gs/userBrand', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'甘肃能开_接入_品牌查询(201710020_in)', biztype:'001']
    }

    @Override
    Map getOutInterface() {
        [route:'', name:'甘肃能开_转接_品牌查询', clsnm:'gsUserPlanQueryService', type:'1', path:'/openapi/V1/partner/ability/production/userPromoCommon', bizcode:'', method:'POST', fmttype:'json', entid:'10', desc:'甘肃能开_转接_品牌查询(201710020_out)', biztype:'001']
    }
