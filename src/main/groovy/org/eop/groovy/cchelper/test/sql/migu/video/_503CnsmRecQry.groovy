 ...
 * @author lixinjie
 */
class _503CnsmRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'503咪咕视频-消费记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕视频-消费记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/video/cnsmRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕视频-消费记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕视频-消费记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕视频-消费记录查询(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'chargeType', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|beginTime,3|endTime,4|chargeType', seqno:'']
		list << [name:'param_out_mapping', value:'1|recordNo,2|productCode,3|productName,4|programId,5|programName,6|watchTime,7|chargeType,8|chargeAmount', seqno:'']
		
		list << [name:'serviceTypeId', value:'82', seqno:'30']
		list << [name:'operateTypeId', value:'5110', seqno:'31']
		list
	}
