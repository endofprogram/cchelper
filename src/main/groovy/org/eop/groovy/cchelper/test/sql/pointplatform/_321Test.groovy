 ...
 * @author lixinjie
 */
class _321Test extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\积分接口\\数据库\\测试环境\\', name:'321积分查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'积分平台_查询_积分查询', clsnm:'pointPlatformIntfService', type:'1', path:'business/pointplatform/pointQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'积分平台_查询_积分查询(20170427_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_积分查询', clsnm:'pointPlatformCommonService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_积分查询(20170427_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		def list = []
		list << [name:'BIPCode', value:'BIP2B421', seqno:'01']
		list << [name:'ActivityCode', value:'T2040091', seqno:'02']
		list << [name:'reqRootElement', value:'AuthReq', seqno:'03']
		list << [name:'rpsRootElement', value:'AuthRes', seqno:'04']
