 ...
 * @author lixinjie
 */
class _02Test extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\辽宁流量统付\\数据库\\测试环境\\', name:'02流量充值']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'在线统一接口_业务_流量充值', clsnm:'', type:'', path:'', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'在线统一接口_业务_流量充值', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'辽宁流量统付_流量充值', clsnm:'lnFlowRechargeService', type:'', path:'/oppf', bizcode:'', method:'POST', fmttype:'json', entid:'10', desc:'辽宁流量统付_流量充值(20170619_out)', biztype:'002']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'Region', value:'240', seqno:'06']
		list << [name:'DonateMonthId', value:'152011029848', seqno:'06']
		list << [name:'DonateMonthValue', value:'1', seqno:'06']
		list << [name:'EffectWayId', value:'152011029726', seqno:'06']
		list << [name:'EffectWayValue', value:'0', seqno:'06']
		list << [name:'IsSendSmsId', value:'152011057779', seqno:'06']
		list << [name:'IsSendSmsValue', value:'0', seqno:'06']
		list
	}
