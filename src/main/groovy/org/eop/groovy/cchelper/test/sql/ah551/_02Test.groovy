...
class _02Test extends AbstractSqlTest {
	...
	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\安徽众包接口\\数据库\\生产环境\\', name:'02产品订购']
	}
	...
	@Override
	Map getInInterface() {
		[route:'1', name:'直连_业务_产品订购', clsnm:'userMobileCommonIntfService', type:'1', path:'business/gs/flowQuery', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'直连_业务_产品订购', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'1', name:'安徽众包_业务_增值产品订购', clsnm:'ahProductOrderService', type:'1', path:'/rest/1.0/s4000Cfm_ser', bizcode:'', method:'GET', fmttype:'json', entid:'1', desc:'安徽众包_业务_增值产品订购(20170515_out)', biztype:'002']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'originalSuccessReturnCode', value:'0000000', seqno:'03']
		...
		list << [name:'ipt_OPERATE_TYPE', value:'A', seqno:'10']
		list << [name:'ipt_SERVICE_NO', value:'${iDItemRange}', seqno:'11']
		list << [name:'ipt_PROD_PRCID', value:'${productId}', seqno:'07']
