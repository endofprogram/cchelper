 ...
 * @author lixinjie
 */
class _3223Test extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\积分接口\\数据库\\测试环境\\', name:'3223转让人信息查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'积分平台_查询_转让人信息查询', clsnm:'pointPlatformIntfService', type:'1', path:'business/pointplatform/trsfPeplInfoQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'积分平台_查询_转让人信息查询(20170427_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_转让人信息查询', clsnm:'pointPlatformCommonService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_转让人信息查询(20170427_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'startRowNum', nflag:'0', seqno:'2']
		list << [type:'1', name:'endRowNum', nflag:'0', seqno:'3']
		list
	}
	...
	List getOutInterfaceParams() {
		def list = []
		list << [type:'1', name:'BMobile', nflag:'1', seqno:'1']
		list << [type:'1', name:'SRowNum', nflag:'1', seqno:'2']
		list << [type:'1', name:'ERowNum', nflag:'1', seqno:'3']
		list
	}
	...
	List getInterfaceParamsMapping() {
		def list = []
		list << [name1:'userMobile', name2:'BMobile', type:'1']
	...
	List getOutInterfaceParamsStatic() {
		def list = []
		list << [name:'BIPCode', value:'BIP2B449', seqno:'01']
		list << [name:'ActivityCode', value:'T2040119', seqno:'02']
		list << [name:'reqRootElement', value:'TradeReq', seqno:'03']
		list << [name:'rpsRootElement', value:'Trade', seqno:'04']
