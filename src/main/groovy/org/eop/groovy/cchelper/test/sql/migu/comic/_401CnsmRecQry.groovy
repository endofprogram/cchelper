package org.eop.groovy.cchelper.test.sql.migu.comic
 ...
 * @author lixinjie
 */
class _401CnsmRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'401咪咕动漫-消费记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕动漫-消费记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/comic/cnsmRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕动漫-消费记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕动漫-消费记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕动漫-消费记录查询(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'userId', nflag:'0', seqno:'20']
		list << [type:'1', name:'beginTime', nflag:'0', seqno:'21']
		list << [type:'1', name:'endTime', nflag:'0', seqno:'22']
		list << [type:'1', name:'chargeType', nflag:'0', seqno:'23']
		list << [type:'1', name:'payWay', nflag:'0', seqno:'24']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userId,2|beginTime,3|endTime,4|chargeType,5|payWay', seqno:'20']
		list << [name:'param_out_mapping', value:'1|businessId,2|businessName,3|productId,4|productName,5|consumeMoneyAmount,6|consumeWay,7|useWay,8|cpName,9|channelName,10|payWay,11|bossId', seqno:'21']
		
		list << [name:'serviceTypeId', value:'95', seqno:'30']
		list << [name:'operateTypeId', value:'4112', seqno:'31']
		list
	}
