 ...
 * @author lixinjie
 */
class _06SSHFYETest extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\河南接口\\数据库\\测试环境\\', name:'06实时话费余额']
	}
	...
	@Override
	Map getInInterface() {
		[route:'1', name:'直连_查询_实时话费余额', clsnm:'userMobileCommonIntfService', type:'1', path:'business/gs/realTimeFeeLeft', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'直连_查询_实时话费余额(20170411_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'1', name:'河南_查询_实时话费余额', clsnm:'hnResultIsArrayQueryService', type:'1', path:'/oppf?postSysParam=true&busiKey=jsonParams', bizcode:'ELE_CHANNEL_QUERY_200650', method:'POST', fmttype:'json', entid:'10', desc:'河南_查询_实时话费余额(20170411_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'2', name:'currentBalance', nflag:'1', seqno:'11']
		list
	}
	...
	List getInterfaceParamsMapping() {
		...
		list << [name1:'currentBalance', name2:'CURRENTBALANCE', type:'2']
		list
	}
