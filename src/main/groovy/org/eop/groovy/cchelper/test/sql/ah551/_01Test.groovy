...
class _01Test extends AbstractSqlTest {
	...
	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\安徽众包接口\\数据库\\生产环境\\', name:'01套餐变更']
	}
	...
	@Override
	Map getInInterface() {
		[route:'1', name:'直连_业务_套餐变更', clsnm:'userMobileCommonIntfService', type:'1', path:'business/gs/flowQuery', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'直连_业务_套餐变更', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'1', name:'安徽众包_业务_基本产品订购', clsnm:'ahMenuChangeService', type:'1', path:'/rest/6.0/s4000Cfm', bizcode:'', method:'GET', fmttype:'json', entid:'1', desc:'安徽众包_业务_基本产品订购(20170515_out)', biztype:'002']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'successResultCode', value:'0000', seqno:'04']
		list << [name:'successResultDesc', value:'变更用户的基本产品资费成功', seqno:'05']
		list << [name:'ipt_enc_BUSI_INFO', value:'{"OPERATE_TYPE":"U","PROD_PRCID":"${prodId}","FUN_FINISH_FLAG":"P"}', seqno:'06']
		list << [name:'ipt_DEVELOP_TIME', value:'${DEVELOP_TIME}', seqno:'07']
		list << [name:'ipt_LOGIN_NO', value:'Y18610145', seqno:'08']
		list << [name:'ipt_MASTER_SERV_ID', value:'1001', seqno:'09']
		list << [name:'ipt_OP_CODE', value:'4083', seqno:'10']
		list << [name:'ipt_SERVICE_NO', value:'${iDItemRange}', seqno:'11']
