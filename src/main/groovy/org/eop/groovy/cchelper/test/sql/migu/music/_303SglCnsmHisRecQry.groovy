 ...
 * @author lixinjie
 */
class _303SglCnsmHisRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'303咪咕音乐-单次消费历史记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕音乐-单次消费历史记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/music/sglCnsmHisRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕音乐-单次消费历史记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕音乐-单次消费历史记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕音乐-单次消费历史记录查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_out_mapping', value:'1|recordNo,2|businessId,3|businessName,4|songName,5|singerName,6|chargeType,7|charge,8|downloadTime,9|operateWay,10|operateChannel,11|downloadStatus', seqno:'21']
		
		list << [name:'serviceTypeId', value:'72', seqno:'30']
		list << [name:'operateTypeId', value:'3105', seqno:'31']
		list
	}
