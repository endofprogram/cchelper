 ...
 * @author lixinjie
 */
class _101MthRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'101咪咕阅读-包月记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕阅读-包月记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/reading/mthRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕阅读-包月记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕阅读-包月记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕阅读-包月记录查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile', seqno:'20']
		list << [name:'param_out_mapping', value:'1|recordNo,2|userMobile,3|columnName,4|productId,5|productName,6|chargeDesc,7|orderTime,8|unorderTime,9|latestOrderApproach,10|status,11|suspendTime,12|resumeTime,13|channelId', seqno:'21']
		
		list << [name:'serviceTypeId', value:'42', seqno:'30']
		list << [name:'operateTypeId', value:'1105', seqno:'31']
		list
	}
