 ...
 * @author lixinjie
 */
class _209BlkRstrDel extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'209咪咕游戏-黑名单删除']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕游戏-黑名单删除', clsnm:'miguIntfService', type:'1', path:'business/migu/game/blkRstrDel', bizcode:'', method:'POST', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕游戏-黑名单删除(20170606_in)', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕游戏-黑名单删除', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕游戏-黑名单删除(20170606_out)', biztype:'002']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'operateTypeId', value:'2202', seqno:'31']
		list
	}
