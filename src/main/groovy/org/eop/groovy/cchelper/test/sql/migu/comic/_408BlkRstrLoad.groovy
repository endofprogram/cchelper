 ...
 * @author lixinjie
 */
class _408BlkRstrLoad extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'408咪咕动漫-黑名单加载']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕动漫-黑名单加载', clsnm:'miguIntfService', type:'1', path:'business/migu/comic/blkRstrLoad', bizcode:'', method:'POST', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕动漫-黑名单加载(20170606_in)', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕动漫-黑名单加载', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕动漫-黑名单加载(20170606_out)', biztype:'002']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'shieldType', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'operateTypeId', value:'4201', seqno:'31']
		list
	}
