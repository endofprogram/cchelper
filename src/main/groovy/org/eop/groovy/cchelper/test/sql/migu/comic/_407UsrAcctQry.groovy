 ...
 * @author lixinjie
 */
class _407UsrAcctQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'407咪咕动漫-用户账户查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕动漫-用户账户查询', clsnm:'miguIntfService', type:'1', path:'business/migu/comic/usrAcctQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕动漫-用户账户查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕动漫-用户账户查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕动漫-用户账户查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userId', seqno:'20']
		list << [name:'param_out_mapping', value:'1|registerTime,2|province,3|city,4|comicCoinRemain,5|businessName,6|shouldPrivilege,7|alreadyPrivilege,8|remainAmount', seqno:'21']
		
		list << [name:'serviceTypeId', value:'95', seqno:'30']
		list << [name:'operateTypeId', value:'4110', seqno:'31']
		list
	}
