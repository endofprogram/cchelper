 ...
 * @author lixinjie
 */
class _305SmmsBlkRstrQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'305咪咕音乐-短/彩信黑名单查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕音乐-短/彩信黑名单查询', clsnm:'miguIntfService', type:'1', path:'business/migu/music/smmsBlkRstrQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕音乐-短/彩信黑名单查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕音乐-短/彩信黑名单查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕音乐-短/彩信黑名单查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_out_mapping', value:'1|recordNo,2|userMobile,3|blackRosterType,4|blackRosterCreateTime,5|blackRosterRemarkInfo,6|blackRosterOperateResult', seqno:'21']
		
		list << [name:'serviceTypeId', value:'72', seqno:'30']
		list << [name:'operateTypeId', value:'3101', seqno:'31']
		list
	}
