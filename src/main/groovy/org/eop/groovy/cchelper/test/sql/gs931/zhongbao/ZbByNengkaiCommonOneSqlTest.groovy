...
abstract class ZbByNengkaiCommonOneSqlTest extends AbstractSqlTest {
    ...
    @Override
    Map getInInterface() {
        [route: '', name: """甘肃统一接口平台_众包_接入_${distinctName}""", clsnm: """$inIntfMap.cls""", type: '1', path: """$inIntfMap.path""", bizcode: depKey==''?'':"""i-${depKey}-00""", method: """$inIntfMap.method""", fmttype: 'json', entid: '', desc: """甘肃统一接口平台_众包_接入_${distinctName}(${version}_in)""", biztype: '001']
	}
