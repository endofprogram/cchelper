 ...
 * @author lixinjie
 */
class _104BlkRstrQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'104咪咕阅读-业务黑名单用户查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕阅读-业务黑名单用户查询', clsnm:'miguIntfService', type:'1', path:'business/migu/reading/blkRstrQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕阅读-业务黑名单用户查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕阅读-业务黑名单用户查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕阅读-业务黑名单用户查询(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'type', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|type', seqno:'031']
		list << [name:'param_out_mapping', value:'1|recordNo,2|userMobile,3|shieldBusi,4|lastShieldDate', seqno:'031']
		
		list << [name:'serviceTypeId', value:'42', seqno:'30']
		list << [name:'operateTypeId', value:'1101', seqno:'31']
		list
	}
