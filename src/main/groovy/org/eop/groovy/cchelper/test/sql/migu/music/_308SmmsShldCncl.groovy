 ...
 * @author lixinjie
 */
class _308SmmsShldCncl extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'308咪咕音乐-短/彩信屏蔽或取消屏蔽']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕音乐-短/彩信屏蔽或取消屏蔽', clsnm:'miguIntfService', type:'1', path:'business/migu/music/smmsShldCncl', bizcode:'', method:'POST', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕音乐-短/彩信屏蔽或取消屏蔽(20170606_in)', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕音乐-短/彩信屏蔽或取消屏蔽', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕音乐-短/彩信屏蔽或取消屏蔽(20170606_out)', biztype:'002']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'blackRosterType', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|operateType,3|blackRosterType', seqno:'20']
		
		list << [name:'serviceTypeId', value:'95', seqno:'30']
		list << [name:'operateTypeId', value:'3201', seqno:'31']
		list
	}
