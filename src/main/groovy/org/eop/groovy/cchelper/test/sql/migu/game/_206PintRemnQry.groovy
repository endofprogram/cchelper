 ...
 * @author lixinjie
 */
class _206PintRemnQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'206咪咕游戏-点数余额查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕游戏-点数余额查询', clsnm:'miguIntfService', type:'1', path:'business/migu/game/pintRemnQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕游戏-点数余额查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕游戏-点数余额查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕游戏-点数余额查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_out_mapping', value:'1|recordNo,2|type,3|resultStatus,4|userType,5|userMobile,6|pointCount', seqno:'21']
		
		list << [name:'serviceTypeId', value:'57', seqno:'30']
		list << [name:'operateTypeId', value:'2106', seqno:'31']
		list
	}
