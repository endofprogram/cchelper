 ...
 * @author lixinjie
 */
class _325Test extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\积分接口\\数据库\\测试环境\\', name:'325异常订单详细信息查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'积分平台_查询_异常订单详细信息查询', clsnm:'pointPlatformIntfService', type:'1', path:'business/pointplatform/abnmlOdrDetlQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'积分平台_查询_异常订单详细信息查询(20170427_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_异常订单详细信息查询', clsnm:'pointPlatformCommonService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_异常订单详细信息查询(20170427_out)', biztype:'001']
	}
	
	@Override
	List getInInterfaceParams() {
		def list = []
		list << [type:'1', name:'eOrderId', nflag:'0', seqno:'1']
		list
	}
	...
	List getOutInterfaceParams() {
		def list = []
		list << [type:'1', name:'EorderID', nflag:'1', seqno:'1']
		list
	}
	...
	List getInterfaceParamsMapping() {
		def list = []
		list << [name1:'eOrderId', name2:'EorderID', type:'1']
		list
	}
	...
	List getOutInterfaceParamsStatic() {
		def list = []
		list << [name:'BIPCode', value:'BIP2B425', seqno:'01']
		list << [name:'ActivityCode', value:'T2040095', seqno:'02']
		list << [name:'reqRootElement', value:'EOrderReq', seqno:'03']
		list << [name:'rpsRootElement', value:'EOrderRes', seqno:'04']
