 ...
 * @author lixinjie
 */
class _406SmsUpDwnQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'406咪咕动漫-短信上下行查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕动漫-短信上下行查询', clsnm:'miguIntfService', type:'1', path:'business/migu/comic/smsUpDwnQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕动漫-短信上下行查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕动漫-短信上下行查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕动漫-短信上下行查询(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'updownFlag', nflag:'0', seqno:'23']
		list << [type:'1', name:'accessNo', nflag:'0', seqno:'24']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userId,2|beginTime,3|endTime,4|updownFlag,5|accessNo', seqno:'20']
		list << [name:'param_out_mapping', value:'1|recordNo,2|userMobile,3|updownFlag,4|accessNo,5|sendTime,6|smsContent', seqno:'21']
		
		list << [name:'serviceTypeId', value:'95', seqno:'30']
		list << [name:'operateTypeId', value:'4113', seqno:'31']
		list
	}
