 ...
 * @author lixinjie
 */
class _210GrayRstrAdd extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'210咪咕游戏-灰名单新增']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕游戏-灰名单新增', clsnm:'miguIntfService', type:'1', path:'business/migu/game/grayRstrAdd', bizcode:'', method:'POST', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕游戏-灰名单新增(20170606_in)', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕游戏-灰名单新增', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕游戏-灰名单新增(20170606_out)', biztype:'002']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'grayRosterSource', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|grayRosterSource', seqno:'20']
		
		list << [name:'serviceTypeId', value:'57', seqno:'30']
		list << [name:'operateTypeId', value:'2205', seqno:'31']
		list
	}
