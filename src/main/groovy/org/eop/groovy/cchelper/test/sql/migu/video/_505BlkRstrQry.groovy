 ...
 * @author lixinjie
 */
class _505BlkRstrQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'505咪咕视频-黑名单查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕视频-黑名单查询', clsnm:'miguIntfService', type:'1', path:'business/migu/video/blkRstrQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕视频-黑名单查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕视频-黑名单查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕视频-黑名单查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile', seqno:'']
		list << [name:'param_out_mapping', value:'1|recordNo,2|queryResult,3|joinBlackRosterTime,4|blackRosterValidTerm', seqno:'']
		
		list << [name:'serviceTypeId', value:'82', seqno:'30']
		list << [name:'operateTypeId', value:'5108', seqno:'31']
		list
	}
