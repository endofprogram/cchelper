package org.eop.groovy.cchelper.test.sql.migu.reading
 ...
 * @author lixinjie
 */
class _102PlyOdrQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'102咪咕阅读-点播订购查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕阅读-点播订购查询', clsnm:'miguIntfService', type:'1', path:'business/migu/reading/plyOdrQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕阅读-点播订购查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕阅读-点播订购查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕阅读-点播订购查询(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'bookName', nflag:'0', seqno:'21']
		list << [type:'1', name:'orderBeginTime', nflag:'0', seqno:'22']
		list << [type:'1', name:'orderEndTime', nflag:'0', seqno:'23']
		list << [type:'1', name:'chargeWay', nflag:'0', seqno:'24']
		list << [type:'1', name:'contentType', nflag:'0', seqno:'25']
		list << [type:'1', name:'isDonate', nflag:'0', seqno:'26']
		list << [type:'1', name:'orderApproach', nflag:'0', seqno:'27']
		list << [type:'1', name:'chapterName', nflag:'0', seqno:'28']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|bookName,3|orderBeginTime,4|orderEndTime,5|chargeWay,6|contentType,7|isDonate,8|orderApproach,9|chapterName', seqno:'30']
		list << [name:'param_out_mapping_1', value:'1|recordNo,2|userMobile,3|name,4|volumeName,5|chapterName,6|orderTime,7|contentType,8|orderApproach,9|chargeDesc,10|chargeWay', seqno:'30']
		list << [name:'param_out_mapping_2', value:'11|price,12|shouldPayAmount,13|couponDeduction,14|actualPayAmount,15|consumeWay,16|productId,17|donateFriend,18|friendMobile,19|channelId', seqno:'30']
		
		list << [name:'serviceTypeId', value:'42', seqno:'40']
		list << [name:'operateTypeId', value:'1106', seqno:'41']
		list
	}
