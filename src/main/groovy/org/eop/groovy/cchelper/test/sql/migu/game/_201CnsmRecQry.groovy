 ...
 * @author lixinjie
 */
class _201CnsmRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'201咪咕游戏-消费记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕游戏-消费记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/game/cnsmRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕游戏-消费记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕游戏-消费记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕游戏-消费记录查询(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'acceptType', nflag:'0', seqno:'20']
		list << [type:'1', name:'acceptContent', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|beginTime,3|endTime,4|acceptType,5|acceptContent', seqno:'20']
		list << [name:'param_out_mapping', value:'1|recordNo,2|operateTime,3|userMobile,4|businessCode,5|businessName,6|businessType,7|packageName,8|payWay,9|partnerCode,10|partnerName,11|basicPrice,12|tackleCode,13|tackleName,14|chargeWay,15|actualCharge,16|discountStrategy', seqno:'21']
		
		list << [name:'serviceTypeId', value:'57', seqno:'30']
		list << [name:'operateTypeId', value:'2102', seqno:'31']
		list
	}
