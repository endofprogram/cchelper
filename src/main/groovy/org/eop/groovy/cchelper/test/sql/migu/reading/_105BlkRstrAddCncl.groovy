 ...
 * @author lixinjie
 */
class _105BlkRstrAddCncl extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'105咪咕阅读-业务黑名单用户添加或取消']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕阅读-业务黑名单用户添加或取消', clsnm:'miguIntfService', type:'1', path:'business/migu/reading/blkRstrAddCncl', bizcode:'', method:'POST', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕阅读-业务黑名单用户添加或取消(20170606_in)', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕阅读-业务黑名单用户添加或取消', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕阅读-业务黑名单用户添加或取消(20170606_out)', biztype:'001']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'shieldBusiness', nflag:'0', seqno:'20']
		list << [type:'1', name:'operateType', nflag:'0', seqno:'20']
		list << [type:'1', name:'operateStaffName', nflag:'0', seqno:'20']
		list << [type:'1', name:'operateStaffId', nflag:'0', seqno:'20']
		list << [type:'1', name:'provinceId', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|shieldBusiness,3|operateType,4|operateStaffName,5|operateStaffId,6|provinceId', seqno:'30']
		
		list << [name:'serviceTypeId', value:'42', seqno:'30']
		list << [name:'operateTypeId', value:'1201', seqno:'31']
		list
	}
