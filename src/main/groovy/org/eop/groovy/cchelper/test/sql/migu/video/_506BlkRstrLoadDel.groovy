package org.eop.groovy.cchelper.test.sql.migu.video
 ...
 * @author lixinjie
 */
class _506BlkRstrLoadDel extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'506咪咕视频-黑名单加载/删除']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕视频-黑名单加载/删除', clsnm:'miguIntfService', type:'1', path:'business/migu/reading/blkRstrLoadDel', bizcode:'', method:'POST', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕视频-黑名单加载/删除(20170606_in)', biztype:'002']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕视频-黑名单加载/删除', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕视频-黑名单加载/删除(20170606_out)', biztype:'002']
	}
	...
	List getInInterfaceParams() {
		...
		list << [type:'1', name:'blackRosterValidTerm', nflag:'0', seqno:'20']
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userMobile,2|blackRosterValidTerm,3|operateStaffName,4|operateStaffId,5|provinceId,6|operateType', seqno:'']
		
		list << [name:'serviceTypeId', value:'42', seqno:'30']
		list << [name:'operateTypeId', value:'5203', seqno:'31']
		list
	}
