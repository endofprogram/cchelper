 ...
 * @author lixinjie
 */
class _301MbrHisOpeRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'301咪咕音乐-会员历史操作记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕音乐-会员历史操作记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/music/mbrHisOpeRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕音乐-会员历史操作记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕音乐-会员历史操作记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕音乐-会员历史操作记录查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_out_mapping', value:'1|recordNo,2|memberLevel,3|operateType,4|operateWay,5|operateChannel,6|operateTime', seqno:'21']
		
		list << [name:'serviceTypeId', value:'72', seqno:'30']
		list << [name:'operateTypeId', value:'3103', seqno:'31']
		list
	}
