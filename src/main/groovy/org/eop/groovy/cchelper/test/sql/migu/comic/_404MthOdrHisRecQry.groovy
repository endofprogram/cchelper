 ...
 * @author lixinjie
 */
class _404MthOdrHisRecQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'404咪咕动漫-包月订购关系历史记录查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕动漫-包月订购关系历史记录查询', clsnm:'miguIntfService', type:'1', path:'business/migu/comic/mthOdrHisRecQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕动漫-包月订购关系历史记录查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕动漫-包月订购关系历史记录查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕动漫-包月订购关系历史记录查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_in_mapping', value:'1|userId,2|beginTime,3|endTime', seqno:'20']
		list << [name:'param_out_mapping', value:'1|productId,2|productName,3|cpName,4|operateTime,5|operateWay,6|accessWay,7|smsAccessCode,8|channelName,9|operateResult', seqno:'21']
		
		list << [name:'serviceTypeId', value:'95', seqno:'30']
		list << [name:'operateTypeId', value:'4111', seqno:'31']
		list
	}
