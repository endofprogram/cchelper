...
public class _603CGSHQPaymentRecord extends AbstractSqlTest {

    @Override
    Map getSqlFile() {
        [dir:'E:\\Work\\java\\cchelper_gen\\', name:'603缴费记录查询']
    }
    ...
    @Override
    Map getInInterface() {
        [route:'', name:'甘肃能开_接入_缴费记录', clsnm:'userMobileCommonIntfService', type:'1', path:'business/gs/CGSHQPaymentRecord', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'甘肃能开_接入_缴费记录(201710020_in)', biztype:'001']
    }

    @Override
    Map getOutInterface() {
        [route:'', name:'甘肃能开_转接_缴费记录', clsnm:'gsPaymentRecordQueryService', type:'1', path:'/openapi/V1/partner/ability/production/busiRec4cmcc', bizcode:'', method:'POST', fmttype:'json', entid:'10', desc:'甘肃能开_转接_缴费记录(201710020_out)', biztype:'001']
    }
