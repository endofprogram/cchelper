 ...
 * @author lixinjie
 */
class _202BlkRstrQry extends AbstractSqlTest {

	@Override
	Map getSqlFile() {
		[dir:'E:\\yaxin\\需求\\咪咕公司接口\\数据库\\测试环境\\', name:'202咪咕游戏-黑名单查询']
	}
	...
	@Override
	Map getInInterface() {
		[route:'', name:'咪咕公司_查询_咪咕游戏-黑名单查询', clsnm:'miguIntfService', type:'1', path:'business/migu/game/blkRstrQry', bizcode:'', method:'GET', fmttype:'json', entid:'', desc:'咪咕公司_查询_咪咕游戏-黑名单查询(20170606_in)', biztype:'001']
	}
	
	@Override
	Map getOutInterface() {
		[route:'', name:'网状网_查询_咪咕游戏-黑名单查询', clsnm:'miguQueryTransactService', type:'1', path:'/Trans/Receiver', bizcode:'', method:'POST', fmttype:'xml', entid:'10', desc:'网状网_查询_咪咕游戏-黑名单查询(20170606_out)', biztype:'001']
	}
	...
	List getOutInterfaceParamsStatic() {
		...
		list << [name:'param_out_mapping', value:'1|recordNo,2|userMobile,3|rosterLevel,4|rosterSource,5|createTime', seqno:'21']
		
		list << [name:'serviceTypeId', value:'57', seqno:'30']
		list << [name:'operateTypeId', value:'2101', seqno:'31']
		list
	}
