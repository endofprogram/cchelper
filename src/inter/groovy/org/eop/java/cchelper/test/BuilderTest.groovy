 ...
 * @since 2017-09-24
 */
class BuilderTest extends AbstractCommonGroovyTest {
    ...
    "interBOSS":{
		...
		Clawer claw = Clawer.fromFastJson(com.alibaba.fastjson.JSON.parseObject(json))
		Builder b = Builder.from(claw)
						.kv('phoneId', 'interBOSS{}.serviceContent{}.phoneId<>')
