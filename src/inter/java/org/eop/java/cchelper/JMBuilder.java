...
public class JMBuilder {
	...
	public JMBuilder kv(String name, Object value) {
		curr.addChild(new KeyValue(curr, name, value));
		return this;
	}
	
	public JMBuilder ko(String name) {
	...
	public JMBuilder ka(String name) {
	...
	public JMBuilder iv(Object value) {
